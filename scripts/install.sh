...
echo ""
echo "First launch:"
echo "  • A short setup window walks you through granting Accessibility and"
echo "    Input Monitoring — AutoSuggest needs both to read context and insert"
echo "    suggestions. It picks up each grant the moment you flip it in System"
echo "    Settings, so there's nothing to restart."
